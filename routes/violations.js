...
router.post("/", jsonParser, function (req, res) {
    ...
    try {
        ...
        switch (device_type) {
            case null:
                kordon_driver.getViolationsData(login, password, ip, port, timestampStart, timestampEnd, res);
                break;
            case 'undefined':
                kordon_driver.getViolationsData(login, password, ip, port, timestampStart, timestampEnd, res);
                break;
            ...
            case vocordID:
                ...
                // res.send(answ);
                vocord_driver.getViolationsData(login, password, ip, port, timestampStart, timestampEnd, res);
                break;
            case orlanID:
                orlan_driver.getViolationsData(login, password, ip, port, timestampStart, timestampEnd, res);
