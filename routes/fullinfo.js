...
router.post("/", jsonParser, function (req, res) {
    ...
    try {
        ...
        switch (device_type) {
            case null:
                kordon_driver.getFullApiInfo(login, password, ip, timestampStart, timestampEnd, res);
                break;
            case 'undefined':
                kordon_driver.getFullApiInfo(login, password, ip, timestampStart, timestampEnd, res);
                break;
            case kordonID:
                ...
                break;
            case vocordID:
                vocord_driver.getFullApiInfo(login, password, ip, timestampStart, timestampEnd, res);
                break;
            case orlanID:
                orlan_driver.getFullApiInfo(login, password, ip, timestampStart, timestampEnd, res);
                break;
            default:
                kordon_driver.getFullApiInfo(login, password, ip, timestampStart, timestampEnd, res);
                break;
